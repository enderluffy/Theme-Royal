                ...
                <div class="row">
                    ...
                    <div class="col-md-12 clearfix" id="customer-account">
                        ...
                        <div class="well" style="background-color: #fff;">
                            <div class="panel-heading">
                                <h3 class="panel-title">
                                    <?= $Lang->get('USER__UPDATE_PASSWORD') ?>
                                </h3>
                            </div>
                            <div class="panel-body">
                                <div class="box no-mb">
                        ...
                        <div class="well" style="background-color: #fff;">
                            <div class="panel-heading">
                                <h3 class="panel-title">
                                    <?= $Lang->get('SHOP__USER_POINTS_TRANSFER') ?>
                                </h3>
                            </div>
                            <div class="panel-body">
                                <div class="box no-mb">
                            ...
                            <div class="panel-heading">
                                ...
                                <table class="table table-bordered" id="users">
                                    <thead>
                                        <tr>
                                            <th>
                                                <?= $Lang->get('DASHBOARD__PURCHASES') ?> ID</th>
                                            <th>
                                                <?= $Lang->get('GLOBAL__CREATED') ?>
                                            </th>
                                            <th>
                                                <?= $Lang->get('SHOP__ITEM_PRICE') ?>
                                            </th>
                                            <th class="right">
                                                <?= $Lang->get('SHOP__ITEMS') ?>
                                            </th>
                                        </tr>
                                    </thead>
						...
						foreach ($histories as $value) { ?>
                                        <tr>
                                            <td>
                                                <?= $value["ItemsBuyHistory"]["id"] ?>
                                            </td>
                                            <td>
                                                <?= $value["ItemsBuyHistory"]["created"] ?>
                                            </td>
                                            <td>
                                                <?= $value["Item"]["price"] ?>
                                            </td>
                        ...
                        <div class="well" style="background-color: #fff;">
                            <div class="panel-heading">
                                <h3 class="panel-title">
                                    <?= $Lang->get('API__MINEGUARD_LABEL') ?>
                                </h3>
                            </div>
                            <div class="panel-body">
                                <p class="lead" style="font-size:14px;">
                                    Qu'est-ce que c'est ? C'est une protection qui permet une connexion au serveur minecraft depuis votre compte seulement avec les IPs affichés ci-dessous. Vous pouvez ajouter une ip ou en retirer une pour que celle-ci accède à votre compte.
                                </p>
                                <div class="row">
                                        ...
                                        <table class="table">
                                            ...
                                            foreach ($api as $key => $value) { ?>
                                                    <tr id="<?= $key ?>">
                                                        ...
                                                        <th>
                                                            <button data-ip-id="<?= $key ?>" class="btn btn-danger delete_ip"><?= $Lang->get('GLOBAL__DELETE') ?></button>
                                                        </th>
                                                    </tr>
                                                    <?php } ?>
                                            </tbody>
                                    ...
                                    <div class="panel-upload">
                                        <div class="row">
                                            <form class="form-inline" method="post" id="skin" method="post" data-ajax="true" data-upload-image="true" action="<?= $this->Html->url(array('action' => 'uploadSkin')) ?>">
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        <input type="button" class="btn btn-success" onclick="$('#choose').click();" value="Séléctionner votre skin" />
                                                        <input name="image" id="choose" class="btn btn-success" type="file" style="visibility:hidden">
                                                    </div>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="row-panel">
                                                        <div class="form-group">
                                                            <button style="float: right" type="submit" class="btn btn-success"><?= $Lang->get('GLOBAL__ADD') ?></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
                                    ...
                                    <div class="panel-upload">
                                        <div class="row">
                                            <form class="form-inline" method="post" id="cape" method="post" data-ajax="true" data-upload-image="true" action="<?= $this->Html->url(array('action' => 'uploadCape')) ?>">
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        <input type="button" class="btn btn-success" onclick="$('#choose').click();" value="Séléctionner votre cape" />
                                                        <input name="image" id="choose" class="btn btn-success" type="file" style="visibility:hidden">
                                                    </div>
                                                    <input name="data[_Token][key]" value="<?= $csrfToken ?>" type="hidden">
                                                </div>
