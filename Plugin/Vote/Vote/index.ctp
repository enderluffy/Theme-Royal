                ...
                <div class="col-xs-12">
                    <div class="col-md-12 well setup-content text-center">
                        ...
                        <form data-ajax="true" action="<?= $this->Html->url(['action' => 'setUser']) ?>" method="post" data-callback-function="afterSetUser">
                            ...
                            <br>
                            <button class="button" type="submit">Passer a l'étape suivante</button>
                        </form>
                            ...
                            foreach ($websitesByServers as $serverName => $websites) {
                                ...
                                echo '<div class="col-md-4">';
                                    echo '<div class="panel panel-default">';
                                        echo '<div class="panel-heading text-center" style="background: #f1a700">';
                                            echo '<h3 class="panel-title" style="color: #ffffff">' . $serverName . '</h3>';
                                        echo '</div>';
                    ...
                    <div class="col-md-12 well setup-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-md-offset-4">
                                <a type="submit" class="btn btn-success btn-block get-reward" data-reward="now"><?= $Lang->get('VOTE__GET_REWARD_NOW') ?></a>
                                <a type="submit" class="btn btn-success btn-block get-reward" data-reward="later"><?= $Lang->get('VOTE__GET_REWARD_LATER') ?></a>
                            </div>
                        </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <div style="background-color: #f1a700" class="alert alert-info"><?= $Lang->get('VOTE__MODAL_DESC') ?></div>
